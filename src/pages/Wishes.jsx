                    ...
                    <AnimatePresence>
                        <Marquee speed={20}
                            ...
                            {wishes.map((wish, index) => (
                                ...
                                >
                                    {/* Background gradient */}
                                    <div className="absolute inset-0 bg-gradient-to-r from-blue-100/50 to-blue-100/50 rounded-xl transform transition-transform group-hover:scale-[1.02] duration-300" />
                                    ...
                                    <div className="relative backdrop-blur-sm bg-white/80 p-4 rounded-xl border border-blue-100/50 shadow-md">
                                        ...
                                        <div className="flex items-start space-x-3 mb-2">
                                            ...
                                            <div className="flex-shrink-0">
                                                <div className="w-8 h-8 rounded-full bg-gradient-to-r from-blue-400 to-blue-400 flex items-center justify-center text-white text-sm font-medium">
