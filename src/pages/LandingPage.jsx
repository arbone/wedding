...
import { Calendar, Clock, MailOpen, Loader2 } from 'lucide-react';
...
const LandingPage = ({ onOpenInvitation }) => {
  ...
  useEffect(() => {
    const img = new Image();
    img.src = '/images/invitation-card-v2.jpg';
      ...
      <AnimatePresence>
        {!isLoaded && (
          <motion.div
            initial={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-50 flex items-center justify-center bg-blue-50"
          >
